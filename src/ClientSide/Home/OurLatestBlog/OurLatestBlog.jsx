		...
		<div className="sectionGap  ">
			<div className="text-center">
				<h1 className="chooseUsSamll pb-[20px] ">
					Our Latest<span className="text-primaryColor "> Blog </span>
				</h1>
				<p className="homePara text-[#1E1E1E]/[.8] mx-auto max-w-[800px] pb-[30px] md:pb-[40px]">
			...
			<div className="slider-container hidden md:block ">
				...
				<div className="mt-10 flex justify-center items-center ">
					<Link to="/blogs">
						<button
							className=" hover:bg-primaryColor hover:text-white px-[20px] text-primaryColor  border border-primaryColor
			...
			<div className="slider-container md:hidden block">
				...
				<div className="hover:bg-primaryColor hover:text-white mt-5 font-helvetica font-bold flex justify-center items-center">
					<Link to="/blogs">
						<button
							className="px-4 py-2 mt-4 text-primaryColor  border border-primaryColor flex justify-center items-center gap-x-[10px]"
							// onClick={() => alert("Navigate to more blogs")}
						>
