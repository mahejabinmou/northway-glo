...
const StudyDestination = () => {
	...
	return (
		<div className="GlobalBg">
			<div className="sectionGap overflow-hidden GlobalBg">
				{/* header for mobile */}
				<div className="md:hidden block ">
					<h1 className="text-[#1E1E1E] chooseUsSamll xs:pb-[20px]  text-center">
						<span className="text-primaryColor ">Study </span> Destination
					</h1>
					<p className="homePara text-[#1E1E1E]/[.8] xs:pb-[30px] text-center ">
						...
						help you navigate the best global educational opportunities,
						tailored to your goals and ambitions. Start your journey towards
				...
				<div className="hidden md:block">
					...
					>
						...
						>
							...
							/>
							<div className="absolute inset-0 group-hover:bg-gradient-to-t from-[#00000085]/[.52] to-primaryColor/[.65]"></div>
