	...
	return (
		<div>
            ...
            px-[28.5px] py-[40px]  '
               ${
									hoveredOffice === name
										? " border-b-primaryColor border-b-2 text-primaryColor"
			...
			<div className="hidden md:block">
				<div
					onMouseEnter={() => handleMouseEnter(name)}
					onMouseLeave={handleMouseLeave}
					className={`bg-primaryColor/[0.32] border border-gray-50/[.2] flex justify-center items-center xl:gap-x-[16px] xl:pl-[28px] xl:pr-[8px]  xl:py-[30px] xl:h-[140px]
