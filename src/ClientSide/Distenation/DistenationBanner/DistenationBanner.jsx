	...
	return (
		<div>
			...
			<div className="  relative">
				...
				{/* Text Section */}
				<div className="absolute  inset-0 mt-[40px] flex flex-col gap-y-[20px] px-[40px] md:px-[60px]  justify-center   lg:px-[5vw]">
					<h1 className="text-4xl lg:text-6xl 2xl:text-6xl text-white  font-bold">
						Study In {countryName}
					</h1>
					<p className="font-normal font-helvetica 2xl:text-[16px] xs:text-[14px] leading-[16px] md:leading-[24px]  2xl:max-w-[800px]  md:max-w-[550px] md:text-xl 2xl:text-2xl lg:text-base text-white mt-2 lg:mt-0 ">
