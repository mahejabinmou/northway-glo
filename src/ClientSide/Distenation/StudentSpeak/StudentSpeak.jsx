...
const StudentSpeak = () => {
    ...
    xs:text-[14px] xs:leading-[21px] xxs:text-[12px] xxs:leading-[18px]  text-white/[.8]"
						...
						{/* Slider */}
						<div className="max-w-[300px]  md:max-w-[1140px] mx-auto relative translate-y-[18%]">
										...
										<div className="bg-white shadow-md  p-2">
											<div className="relative">
												<LazyLoadImage
													src={StudentImg?.image}
													alt={StudentImg.name}
													className="w-full  xs:h-64  object-cover "
												/>
												<button className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center ">
													<svg
														xmlns="http://www.w3.org/2000/svg"
...
const NextArrow = (props) => {
	...
	return (
		<button
			className="ml-[50%] mr-[50%] absolute  bottom-[-50px] left-4 z-10  rounded-full p-2 hover:bg-primaryColor hover:text-white  bg-[#F6941E33]/[.2] text-[#1E1E1E]
       "
			onClick={onClick}
		>
			<svg
...
const PrevArrow = (props) => {
	...
	return (
      ...
      rounded-full p-2 hover:bg-primaryColor hover:text-white"
			onClick={onClick}
		>
			<svg
				xmlns="http://www.w3.org/2000/svg"
