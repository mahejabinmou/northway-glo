	...
	return (
		<div>
          ...
          <label className="inline-flex items-center  text-[#1E1E1E] custom-checkbox">
            ...
            <span className="text-primaryColor ml-[5px]">
              {"    "}
              terms & conditions
            </span>
          </label>
				...
				<button
					type="submit"
					className=" bg-white flex justify-center text-primaryColor border border-primaryColor items-center hover:bg-primaryColor hover:text-white py-2 px-4 
